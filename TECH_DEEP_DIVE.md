...
> 仓库：https://github.com/lgy12i/baobao
> 文档目标：把"个人全栈电商项目"与 **Docker 容器化、Kubernetes 集群编排、AI Agent + RAG 知识库** 三大技术方向的结合点讲清楚——做了什么、为什么这么做、关键代码与配置在哪、如何复现。
...
**宝宝商城**是一个参考淘宝、京东、拼多多设计的 B2C 全栈电商平台，融合霓虹潮流主题，包含完整的电商业务闭环：
